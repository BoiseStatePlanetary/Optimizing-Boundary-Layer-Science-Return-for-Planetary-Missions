...
\begin{itemize}
    ...
    \item Test more detectors and tune cooldown window in addition to detector parameters
    \item Test transformer's ability to accept different or mixed frequency time series using the embedding
